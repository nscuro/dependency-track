...
public enum ConfigKey implements Config.Key {
    ...
    OSSINDEX_RETRY_MAX_ATTEMPTS("ossindex.retry.max.attempts", 6),
    OSSINDEX_RETRY_BACKOFF_MULTIPLIER("ossindex.retry.backoff.multiplier", 2),
    OSSINDEX_RETRY_BACKOFF_INITIAL_DURATION_MS("ossindex.retry.backoff.initial.duration.ms", Duration.ofSeconds(1).toMillis()),
    OSSINDEX_RETRY_BACKOFF_MAX_DURATION_MS("ossindex.retry.backoff.max.duration.ms", Duration.ofSeconds(60).toMillis()),
    SNYK_THREAD_POOL_SIZE("snyk.thread.pool.size", 10),
    SNYK_RETRY_MAX_ATTEMPTS("snyk.retry.max.attempts", 6),
    SNYK_RETRY_BACKOFF_MULTIPLIER("snyk.retry.backoff.multiplier", 2),
    SNYK_RETRY_BACKOFF_INITIAL_DURATION_MS("snyk.retry.backoff.initial.duration.ms", Duration.ofSeconds(1).toMillis()),
    SNYK_RETRY_BACKOFF_MAX_DURATION_MS("snyk.retry.backoff.max.duration.ms", Duration.ofSeconds(60).toMillis()),
