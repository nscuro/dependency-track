...
import static org.dependencytrack.model.ConfigPropertyConstants.TELEMETRY_ENABLED;
...
public class TelemetrySubmissionTask implements Subscriber {
    ...
    public void inform(final Event event) {
        ...
        try (final var qm = new QueryManager()) {
            final boolean isEnabled = qm.isEnabled(TELEMETRY_ENABLED);
            if (!isEnabled) {
        ...
        try {
            ...
            submit(this.url, serializedData);
    ...
    private void submit(final String url, final String serializedData) throws IOException {
        ...
        // NB: A redirect strategy can be defined on the client-level.
        // Because our clients are pooled though, we shouldn't modify them
        // to avoid unintended behavior changes in other places.
