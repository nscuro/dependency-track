...
public enum ConfigPropertyConstants {
    ...
    TELEMETRY_ENABLED("telemetry", "submission.enabled", String.valueOf(Config.getInstance().getPropertyAsBoolean(ConfigKey.TELEMETRY_SUBMISSION_ENABLED)), PropertyType.BOOLEAN, "Whether submission of telemetry data is enabled"),
